...
while True:
    ...
    if menu == "1":
        ...
        while resultado_login:
            ...
            if opcao == "1":
                conta_acessada.saldo, conta_acessada.extrato = Conta.deposito(conta_acessada.saldo, conta_acessada.extrato)
            elif opcao == "2":
                conta_acessada.saldo, conta_acessada.extrato, conta_acessada.numero_saques = Conta.saque(conta_acessada.saldo, conta_acessada.extrato, conta_acessada.numero_saques)
            elif opcao == "3":
                Conta.mostrar_extrato(conta_acessada.extrato, conta_acessada.saldo)
            elif opcao == "4":
                dados_cesta = Conta.alterar_cesta()
            elif opcao == "5":
                nova_conta = Conta.cadastrar_conta(base_clientes[id_cliente].cpf)
                ...
                conta_usada = input(f"""
                                    ...
                                    {Conta.listar_contas(base_clientes[id_cliente].cpf)}
